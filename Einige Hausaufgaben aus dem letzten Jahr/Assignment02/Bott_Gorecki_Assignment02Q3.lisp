...
;b) searches element a in binary tree tr and returns the level of a in tr
...
;c) deletes an element out of a tree tr
...
; d) applies a function f to the elements of a list a
