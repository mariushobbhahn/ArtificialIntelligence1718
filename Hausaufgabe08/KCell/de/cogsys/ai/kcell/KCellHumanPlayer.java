 ...
 */
public class KCellHumanPlayer implements Agent<Integer,List<Integer>> {

    private BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
    
	private int inputMove(final Game<Integer,List<Integer>> game) {
        System.out.println(
	...
	@Override
	public Integer computeMove(Game<Integer,List<Integer>> game) {
